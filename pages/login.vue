<template>
  <form @submit.prevent="signIn" class="w-full h-screen flex justify-center items-center">
    <div class="bg-white w-[450px] shadow-lg border py-5 px-6 rounded-xl">
      ...
      <input type="email" required v-model="email" placeholder="Your Email" :class="errorStat ? 'border-red-500' : 'border-slate-100'" class="w-full px-3 h-12 border-2 rounded-md outline-none mb-5" />
